...
| `verifier/` | Loop artefacts (not a parser) | Independent gate: measures all eight verification scores from named checks and proves the gate can fail via mutation self-test |
